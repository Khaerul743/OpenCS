...
class SaveFileHandler:
    ...
    def create_agent_directory(self, user_id: int, agent_id: int) -> str:
        """
    ...
    def delete_file(self, file_path: str, file_name: str) -> None:
        """
        Delete a file based on directory path and file name

        Args:
            file_path: Directory path where the file is stored
        ...
        try:
            ...
            self.logger.error(f"Failed to delete file {file_name} in {file_path}: {e}")
            raise e
